...
namespace MateoPugaProyectoII.Controllers
{
    public class BurgersController : Controller
    {
        ...
        public BurgersController(MateoPugaDB context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BurgerID,Name,WithChees,Precio")] Burger burger)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BurgerID,Name,WithChees,Precio")] Burger burger)
        {
